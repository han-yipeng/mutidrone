...
"""autogenerated by genpy from quadrotor_msgs/PolyTraj.msg. Do not edit."""
import codecs
import sys
...
class PolyTraj(genpy.Message):
  _md5sum = "81aee99c275c89bf863a05641e3f2fad"
  _type = "quadrotor_msgs/PolyTraj"
...
float32[] duration
"""
  __slots__ = ['drone_id','traj_id','start_time','traj_start_time','replan_duration','order','type','coef_x','coef_y','coef_z','duration']
  _slot_types = ['int16','int32','time','float64','float64','uint8','uint8','float32[]','float32[]','float32[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       drone_id,traj_id,start_time,traj_start_time,replan_duration,order,type,coef_x,coef_y,coef_z,duration
    ...
    if args or kwds:
      ...
      if self.replan_duration is None:
        self.replan_duration = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_hi2I2d2B().pack(_x.drone_id, _x.traj_id, _x.start_time.secs, _x.start_time.nsecs, _x.traj_start_time, _x.replan_duration, _x.order, _x.type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_id, _x.traj_id, _x.start_time.secs, _x.start_time.nsecs, _x.traj_start_time, _x.replan_duration, _x.order, _x.type,) = _get_struct_hi2I2d2B().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_hi2I2d2B = None
def _get_struct_hi2I2d2B():
    global _struct_hi2I2d2B
    if _struct_hi2I2d2B is None:
        _struct_hi2I2d2B = struct.Struct("<hi2I2d2B")
    return _struct_hi2I2d2B
