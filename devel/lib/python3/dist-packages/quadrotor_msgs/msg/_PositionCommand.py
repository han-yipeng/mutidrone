...
class PositionCommand(genpy.Message):
  _md5sum = "34336a5fbd5ca6e3e6390884c78bb8de"
...
float64 z"""
  ...
  __slots__ = ['header','position','velocity','acceleration','jerk','snap','yaw','yaw_dot','yaw_acc','kx','kv','trajectory_id','trajectory_flag']
  _slot_types = ['std_msgs/Header','geometry_msgs/Point','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','float64','float64','float64','float64[3]','float64[3]','uint32','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,position,velocity,acceleration,jerk,snap,yaw,yaw_dot,yaw_acc,kx,kv,trajectory_id,trajectory_flag
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_18d().pack(_x.position.x, _x.position.y, _x.position.z, _x.velocity.x, _x.velocity.y, _x.velocity.z, _x.acceleration.x, _x.acceleration.y, _x.acceleration.z, _x.jerk.x, _x.jerk.y, _x.jerk.z, _x.snap.x, _x.snap.y, _x.snap.z, _x.yaw, _x.yaw_dot, _x.yaw_acc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position.x, _x.position.y, _x.position.z, _x.velocity.x, _x.velocity.y, _x.velocity.z, _x.acceleration.x, _x.acceleration.y, _x.acceleration.z, _x.jerk.x, _x.jerk.y, _x.jerk.z, _x.snap.x, _x.snap.y, _x.snap.z, _x.yaw, _x.yaw_dot, _x.yaw_acc,) = _get_struct_18d().unpack(str[start:end])
      start = end
      end += 24
