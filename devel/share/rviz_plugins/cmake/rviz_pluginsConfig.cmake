...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/han/transport-multiple/src/MARTS-Planner/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/han/transport-multiple/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/han/transport-multiple/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/han/transport-multiple/src/MARTS-Planner/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
