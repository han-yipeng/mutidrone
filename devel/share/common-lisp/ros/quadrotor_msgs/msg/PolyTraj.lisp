...
(cl:defclass <PolyTraj> (roslisp-msg-protocol:ros-message)
  ((drone_id
   ...
   (start_time
    ...
    :initform 0)
   (traj_start_time
    :reader traj_start_time
    :initarg :traj_start_time
    :type cl:float
    :initform 0.0)
   (replan_duration
    :reader replan_duration
    :initarg :replan_duration
    :type cl:float
    :initform 0.0)
   (order
    :reader order
...
(cl:ensure-generic-function 'traj_start_time-val :lambda-list '(m))
(cl:defmethod traj_start_time-val ((m <PolyTraj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:traj_start_time-val is deprecated.  Use quadrotor_msgs-msg:traj_start_time instead.")
  (traj_start_time m))

(cl:ensure-generic-function 'replan_duration-val :lambda-list '(m))
(cl:defmethod replan_duration-val ((m <PolyTraj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:replan_duration-val is deprecated.  Use quadrotor_msgs-msg:replan_duration instead.")
  (replan_duration m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PolyTraj>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'traj_start_time))))
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'replan_duration))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PolyTraj>) istream)
  "Deserializes a message object of type '<PolyTraj>"
    ...
    (cl:setf (cl:slot-value msg 'traj_start_time) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'replan_duration) (roslisp-utils:decode-double-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PolyTraj>)))
  ...
  "81aee99c275c89bf863a05641e3f2fad")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PolyTraj)))
  "Returns md5sum for a message object of type 'PolyTraj"
  "81aee99c275c89bf863a05641e3f2fad")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PolyTraj>)))
  ...
  (cl:format cl:nil "int16 drone_id~%int32 traj_id~%time start_time~%float64 traj_start_time~%float64 replan_duration~%~%uint8 order~%uint8 type~%float32[] coef_x~%float32[] coef_y~%float32[] coef_z~%float32[] duration~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PolyTraj)))
  "Returns full string definition for message of type 'PolyTraj"
  (cl:format cl:nil "int16 drone_id~%int32 traj_id~%time start_time~%float64 traj_start_time~%float64 replan_duration~%~%uint8 order~%uint8 type~%float32[] coef_x~%float32[] coef_y~%float32[] coef_z~%float32[] duration~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PolyTraj>))
  ...
  (cl:list 'PolyTraj
    ...
    (cl:cons ':traj_start_time (traj_start_time msg))
    (cl:cons ':replan_duration (replan_duration msg))
