...
class PolyTraj {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.traj_start_time = null;
      this.replan_duration = null;
      this.order = null;
      this.type = null;
      this.coef_x = null;
      this.coef_y = null;
      ...
      if (initObj.hasOwnProperty('traj_start_time')) {
        this.traj_start_time = initObj.traj_start_time
      }
      else {
        this.traj_start_time = 0.0;
      }
      if (initObj.hasOwnProperty('replan_duration')) {
        this.replan_duration = initObj.replan_duration
      }
      else {
        this.replan_duration = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [traj_start_time]
    bufferOffset = _serializer.float64(obj.traj_start_time, buffer, bufferOffset);
    // Serialize message field [replan_duration]
    bufferOffset = _serializer.float64(obj.replan_duration, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [traj_start_time]
    data.traj_start_time = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [replan_duration]
    data.replan_duration = _deserializer.float64(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '81aee99c275c89bf863a05641e3f2fad';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.traj_start_time !== undefined) {
      resolved.traj_start_time = msg.traj_start_time;
    }
    else {
      resolved.traj_start_time = 0.0
    }

    if (msg.replan_duration !== undefined) {
      resolved.replan_duration = msg.replan_duration;
    }
    else {
      resolved.replan_duration = 0.0
    }
